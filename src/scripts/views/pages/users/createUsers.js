        ...
        <div class="md:flex flex-col md:w-full md:h-full">
            <form method="POST" id="form_users" action="">                
                <div class=" md:flex flex-col ">
                    ...
                    <div>
                        <input type="text" id="username_users" placeholder="ranprecast-admin" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-300 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                <div class=" md:flex flex-col ">
                    <div class="mb-3">
                    ...
                    <div>
                        <input type="text" id="password_users" placeholder="ranprecast-admin" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:placeholder-gray-300 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
